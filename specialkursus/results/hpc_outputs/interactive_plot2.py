...
def plot_graph(dataset, type_plot, metric_to_plot):
    ...
    #["Accuracy", "Entropy", "LPD", "ECE", "MCE", "OOD"]
    ...
    for i, K in enumerate(K_list):
        ...
        if type_plot == "prior_variance_T_1":
            ...
            ax.plot(prior_sigmas, df_metric2.values, marker='o', label=f"K={K}, T={T2}", color=color_list2[i])
            ...
            #ax.hlines(dataset_baseline[dataset][metric_to_plot], 0, 10, color='black', linestyle='--', label=f"{dataset} baseline")
