...
import time
from filter_without_compass import run_full_filter, initialize_filter
...
ani.save(f"plots/without_compass/{dataset}_{particles}particles_{iterations}iterations.gif", writer=PillowWriter(fps=5))
